...
public class RecycleAdapter extends RecyclerView.Adapter<RecycleAdapter.ViewHolder> implements View.OnClickListener,
    ...
    public RecycleAdapter(Context context, ArrayList<String> myDataset, ArrayList<String> name2, ArrayList<String> price2) {
...
//        }
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == holder.pricetxt.getId()) {
            Toast.makeText(sContext, holder.pricetxt.getText(), Toast.LENGTH_SHORT).show();
...
//
//            Toast.makeText(sContext, "Item " + holder.pricetxt.getText() + " has been removed from list",
